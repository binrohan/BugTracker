...
@Injectable()
export class ProjectArchivedTicketsResolver implements Resolve<TicketRes>{
    ticketParams: any = { pageSize: 9, pageIndex: 0, stateBy: 'archived', filter: '', orderBy: 'iddesc'};
